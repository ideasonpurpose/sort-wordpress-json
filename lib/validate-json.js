 ...
 * @param {any|string} sorted_ - The sorted JSON data (object or string).
...
export function validateJson(_original, _sorted) {
  ...
  try {
    original = typeof _original === "string" ? JSON.parse(_original) : _original;
  } catch (e) {
  ...
  if (!isEqual(original, sorted)) {
    throw new Error("Something went wrong, input and output files are not equivalent");
  }
